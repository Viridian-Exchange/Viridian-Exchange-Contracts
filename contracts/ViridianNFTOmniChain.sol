...
contract ViridianNFTOmniChain is ERC721, Ownable, BaseRelayRecipient, NonblockingReceiver {
    ...
    mapping(uint256 => bool) public openingUnlocked;
    bool public allowWhitelistMinting = false;
     ...
     */
     constructor(address _forwarder, address payable _treasury, string memory _packURI, string memory _openURI) ERC721("Viridian NFT", "VNFT")  {
    ...
    */
    function safeTransferFromOmniChain(uint256 tokenId, address _to, uint16 _chainId) public payable {
