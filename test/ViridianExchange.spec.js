...
const ViridianExchange = artifacts.require('ViridianExchangeSimple');
...
contract('ViridianExchange', (accounts) => {
  ...
  beforeEach(async () => {
    ...
    await nft.addAdmin(exchange.address);
