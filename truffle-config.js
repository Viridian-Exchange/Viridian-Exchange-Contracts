...
const mnemonic = "bomb hood swallow nerve wrong two pilot betray medal symbol impose chase";
...
module.exports = {
  ...
  networks: {
    ...
    development: {
     host: "192.168.1.151",     // Localhost (default: none)
    ...
    ropsten: {
      provider: () => new HDWalletProvider(mnemonic, `wss://ropsten.infura.io/ws/v3/c2ccaf282d324e8983bcb0c6ffaa05a6`),//.engine._blockTracker._pollingInterval = 1800000,
